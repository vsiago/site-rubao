...
const ImageCropper = ({ imageSrc }) => {
  ...
  const handleDownload = () => {
    ...
    link.download = "feed-rubao20.png";
  ...
  return (
    <div className="relative w-[300px] h-[300px]">
      ...
      <button
        onClick={handleSave}
        className="absolute -bottom-20 font-bold bg-sky-500 border-2 border-sky-300 p-3 w-full rounded-full hover:bg-sky-200 text-white hover:text-blue-900 transition-all duration-150 ease-in-out"
        style={{ zIndex: 4 }}
