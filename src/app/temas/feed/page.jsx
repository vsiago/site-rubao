...
import ImageCropper from "./ImageCropperFeed"; // Ajuste o caminho conforme necessário
          ...
          {!imageSrc && (
            <div className="relative h-72 w-64 mx-auto">
              ...
              <button
                ...
                className="absolute top-4 -right-11 p-2 bg-blue-500 text-white rounded-full shadow-lg hover:bg-blue-600"
              >
                <FiCopy size={28} />
              </button>
              {copySuccess && (
